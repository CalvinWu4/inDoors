...
var places = "(".concat(_ambig.person.verbs.join('|'), ")");
var list$4 = [// ==== Region ====
//West Norforlk
{
...
matches = matches.concat(_11Adverbs); // cache the easier conditions up-front
